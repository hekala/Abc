...
namespace Abc.Tests
{
    ...
    {
        private const string notTested = "<{0}> is not tested"; //konstandid
        ...
        {
            if (type == null) Assert.Inconclusive(notSpecified); //kui tuup pole maaratud, siis seda tuupi pole olemas
